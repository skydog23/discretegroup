...
public abstract class TextSlider<T extends Number> extends JPanel  {
	...
	public static class Integer extends TextSlider<java.lang.Integer>	{
		...
		int textToSlider()	{
			return java.lang.Integer.valueOf(super.textField.getText().replace(",","."));
		}
		...
		public void setMax(java.lang.Integer max) {
		    Vector<ActionListener> remember = listeners;
		    listeners = null;
			String text=super.textField.getText().replace(",",".");
	...
	public static class Double extends TextSlider<java.lang.Double>	{
		...
		@Override
		int textToSlider()	{
			return numberToSlider(java.lang.Double.valueOf(super.textField.getText().replace(",",".")));
		}
		...
		@Override
		void adjustSliderMinMax() {
			double val= java.lang.Double.valueOf(super.textField.getText().replace(",","."));
